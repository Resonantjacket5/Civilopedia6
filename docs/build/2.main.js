...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__improvement__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(276);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ImprovementPageModule", function() { return ImprovementPageModule; });
...
var ImprovementPageModule = (function () {
    function ImprovementPageModule() {
    }
    return ImprovementPageModule;
}());
ImprovementPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__improvement__["a" /* ImprovementPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__improvement__["a" /* ImprovementPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__improvement__["a" /* ImprovementPage */]
        ]
    })
], ImprovementPageModule);

//# sourceMappingURL=improvement.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_game_data_game_data__ = __webpack_require__(197);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ImprovementPage; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var ImprovementPage = (function () {
    function ImprovementPage(navCtrl, navParams, gameData) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.gameData = gameData;
        var id = navParams.get("improvementId");
        this.gameData.getImprovement(id).subscribe(function (data) {
            _this.improvement = data;
            console.log(_this.improvement);
        });
    }
    ImprovementPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ImprovementPage');
    };
    return ImprovementPage;
}());
ImprovementPage = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPage */])({
        name: "improvement",
        segment: "improvements/:improvementId"
    }),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'page-improvement',template:/*ion-inline-start:"C:\Users\Wesley\Code\CivilopediaSix\src\pages\improvement\improvement.html"*/'<!--\n  Generated template for the ImprovementPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Improvement</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div *ngIf="improvement">\n    <ion-card>\n      <ion-item-group>\n        <ion-item>\n          <ion-thumbnail item-end>\n            <img src="./assets/images/improvements/{{improvement.id}}.png"/>\n          </ion-thumbnail>\n          <h2>\n            {{improvement.name}}\n          </h2>\n        </ion-item>\n        <div *ngIf="improvement.terrains">\n          <ion-item-divider>\n            Allowed Terrain\n          </ion-item-divider>\n          <ion-item >\n            <div *ngFor="let terrain of improvement.terrains">\n              {{terrain}}\n            </div>\n          </ion-item>\n        </div>\n      </ion-item-group>\n    </ion-card>\n    <ion-card>\n      <ion-card-content>\n        <ion-item-group>\n          <ion-item-divider>\n            Base yields\n          </ion-item-divider>\n          <ion-item *ngFor="let y of improvement.base_yields">\n            <div *ngIf="y.yield">\n              +{{y.value}} <civ-icon category="yields" [id]=y.yield></civ-icon>{{y.yield}}\n              <div *ngIf="y.adj">\n                for every adjacent {{y.adj.id}}\n              </div>\n            </div>\n            <div>\n              {{y.notes}}\n            </div>\n          </ion-item>\n          <!-- <ion-item-divider>\n            Bonus yields\n          </ion-item-divider>\n          <ion-item *ngFor="let y of improvement.bonus_yields">\n            +{{y.value}} <civ-icon category="yields" [id]=y.yield></civ-icon> {{y.yield}}\n          </ion-item> -->\n          <div *ngFor="let y of improvement.bonus_yields">\n            <ion-item-divider>\n              Research {{y.id}}\n            </ion-item-divider>\n            <ion-item>\n              <ion-row>\n                <ion-col>\n                    +{{y.value}} <civ-icon category="yields" [id]=y.yield></civ-icon> {{y.yield}}\n                    <div *ngIf="y.adj">\n                      for every adjacent {{y.adj.id}}\n                    </div>\n                </ion-col>\n              </ion-row>\n            </ion-item>\n          </div>\n        </ion-item-group>\n      </ion-card-content>\n    </ion-card>\n    <div *ngIf="improvement.requires">\n      <ion-card>\n        <info-card category="tecivic" [id]="improvement.requires">\n\n        </info-card>\n      </ion-card>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"C:\Users\Wesley\Code\CivilopediaSix\src\pages\improvement\improvement.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
